...
export const termsV100 = {
  version: '1.0.0',
  date: '2024-01-01',
  changes: ['최초 제정'],
  content: `<p>제임스컴퍼니(이하 '회사'라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.</p>
...
<ol>
<li><strong>홈페이지 회원 가입 및 관리 : 사업자/단체 홈페이지 탈퇴 시까지</strong><br>
...
선택항목 : 관심분야, 과거 구매내역</li>

<li><strong>인터넷 서비스 이용과정에서 아래 개인정보 항목이 자동으로 생성되어 수집될 수 있습니다.</strong><br>
IP주소, 쿠키, MAC주소, 서비스 이용기록, 방문기록, 불량 이용기록 등</li>
</ol>
...
회사는 전자적 파일 형태로 기록․저장된 개인정보는 기록을 재생할 수 없도록 로우레밸포멧(Low Level Format) 등의 방법을 이용하여 파기하며, 종이 문서에 기록․저장된 개인정보는 분쇄기로 분쇄하거나 소각하여 파기합니다.</li>
</ol>
...
성명 : 강홍재<br>
직책 : 대표<br>
연락처 : 010-8327-6861, jamescompanykr@gmail.com</p>
...
<p><strong>▶ 경찰청 사이버안전국 : 182 (http://cyberbureau.police.go.kr)</strong></p>
